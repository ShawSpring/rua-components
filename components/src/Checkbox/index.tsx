...
const boxStyles = tv({
  ...
  variants: {
    isSelected: {
      false:
        "dark:[--color:colors.zinc-400)] group-pressed:[--color:theme(colors.gray.500)] dark:group-pressed:[--color:theme(colors.zinc.300)] border-[--color] bg-white [--color:theme(colors.gray.400)] dark:bg-zinc-900",
