...
const resizerStyles = tv({
  extend: focusRing,
  base: "resizing:bg-blue-600 forced-colors:resizing:bg-[Highlight] resizing:w-[2px] resizing:pl-[7px] box-content h-5 w-px translate-x-[8px] cursor-col-resize rounded bg-gray-400 bg-clip-content px-[8px] py-1 -outline-offset-2 dark:bg-zinc-500 forced-colors:bg-[ButtonBorder]",
});
